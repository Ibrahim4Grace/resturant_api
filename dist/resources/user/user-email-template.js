...
exports.newAddressAdded = exports.PasswordResetEmail = exports.welcomeEmail = exports.sendOTPByEmail = void 0;
const sendOTPByEmail = (user, otp) => {
...
const newAddressAdded = (user, addressData) => {
    return {
        from: process.env.nodemailerEmail,
        to: user.email,
...
exports.newAddressAdded = newAddressAdded;
//# sourceMappingURL=user-email-template.js.map